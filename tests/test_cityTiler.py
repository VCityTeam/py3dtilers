...
class Test_Tile(unittest.TestCase):
    ...
    def test_building_basic_case(self):
        ...
        city_tiler.args = Namespace(obj=None, loa=None, lod1=False, crs_in='EPSG:3946', crs_out='EPSG:3946', offset=[0, 0, 0])
    ...
    def test_building_lod1(self):
        ...
        objects_type.set_cursor(cursor)
        city_tiler = CityTiler()
        city_tiler.args = Namespace(obj=None, loa=None, lod1=True, crs_in='EPSG:3946', crs_out='EPSG:3946', offset=[0, 0, 0])
        tileset = city_tiler.from_3dcitydb(cursor, objects_type)
        tileset.get_root_tile().set_bounding_volume(BoundingVolumeBox())
        tileset.write_to_directory(directory)
        cursor.close()
    ...
    def test_building_loa(self):
        ...
        objects_type.set_cursor(cursor)
        city_tiler = CityTiler()
        city_tiler.args = Namespace(obj=None, loa="tests/city_tiler_test_data/polygons", lod1=False, crs_in='EPSG:3946', crs_out='EPSG:3946', offset=[0, 0, 0])
        tileset = city_tiler.from_3dcitydb(cursor, objects_type)
        tileset.get_root_tile().set_bounding_volume(BoundingVolumeBox())
        tileset.write_to_directory(directory)
        cursor.close()
    ...
    def test_building_loa_lod1(self):
        ...
        objects_type.set_cursor(cursor)
        city_tiler = CityTiler()
        city_tiler.args = Namespace(obj=None, loa="tests/city_tiler_test_data/polygons", lod1=True, crs_in='EPSG:3946', crs_out='EPSG:3946', offset=[0, 0, 0])
        tileset = city_tiler.from_3dcitydb(cursor, objects_type)
        tileset.get_root_tile().set_bounding_volume(BoundingVolumeBox())
        tileset.write_to_directory(directory)
        cursor.close()
