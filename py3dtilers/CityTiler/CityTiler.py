...
def from_3dcitydb(cursor, objects_type, create_lod1=False, create_loa=False, polygons_path=None, split_surfaces=False, with_texture=False):
    ...
    return create_tileset(objects_to_tile, create_lod1=create_lod1, create_loa=create_loa, polygons_path=polygons_path, extension_name=extension_name, with_texture=with_texture)
